 ...
 * This defines the personality, rules, and core knowledge of the assistant.
 */
...
export const FALLBACK_MESSAGES = {
  TIMELINE: "Here is the official election timeline process. [SHOW_TIMELINE]",
  BOOTH: "Let me walk you through exactly what happens inside the polling booth. [SHOW_BOOTH]",
  FORM_6: "Form 6 is used by new voters to get their name on the Electoral Roll. You can find it on the official NVSP or ECI portal.",
  VOTER_ID: "Remember: Your Voter ID (EPIC) is just an ID. Your name MUST be on the Electoral Roll to vote. If you lost your ID, you can use 12 alternative documents like Aadhaar or PAN.",
  OFFLINE: "I am currently running in offline mode. Please use the quick action buttons above or ask me specifically about the 'timeline', the 'polling booth', or 'eligibility'.",
  NEUTRAL_FAILSAFE: "As your Voter Assistant, I can provide all the tools and info to help you vote, but the choice of candidate is a secret and sacred decision that belongs only to you. My job is to ensure you get to the booth comfortably."
};
